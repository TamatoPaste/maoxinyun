...
public class Mat {
    ...
    // 若Mask(i,j) ==1 ,则B(i,j) = A(i,j), 否则 B(i,j)不变
    ...
    public String toString() {
        return "Mat [ " +
                rows() + "*" + cols() + "*" + org.opencv.core.CvType.typeToString(type()) +
    ...
    public int put(int row, int col, double... data) {
        int t = type();
        if (data == null || data.length % org.opencv.core.CvType.channels(t) != 0)
            throw new UnsupportedOperationException(
                    "Provided data element number (" +
                            (data == null ? 0 : data.length) +
                            ") should be multiple of the Mat channels count (" +
                            org.opencv.core.CvType.channels(t) + ")");
        ...
        if (data == null || data.length % org.opencv.core.CvType.channels(t) != 0)
            throw new UnsupportedOperationException(
                    "Provided data element number (" +
                            ...
                            ") should be multiple of the Mat channels count (" +
                            org.opencv.core.CvType.channels(t) + ")");
        if (org.opencv.core.CvType.depth(t) == org.opencv.core.CvType.CV_32F) {
        ...
        if (data == null || data.length % org.opencv.core.CvType.channels(t) != 0)
            throw new UnsupportedOperationException(
                    "Provided data element number (" +
                            ...
                            ") should be multiple of the Mat channels count (" +
                            org.opencv.core.CvType.channels(t) + ")");
        if (org.opencv.core.CvType.depth(t) == org.opencv.core.CvType.CV_32S) {
        ...
        if (data == null || data.length % org.opencv.core.CvType.channels(t) != 0)
            throw new UnsupportedOperationException(
                    "Provided data element number (" +
                            ...
                            ") should be multiple of the Mat channels count (" +
                            org.opencv.core.CvType.channels(t) + ")");
        if (org.opencv.core.CvType.depth(t) == org.opencv.core.CvType.CV_16U || org.opencv.core.CvType.depth(t) == org.opencv.core.CvType.CV_16S) {
        ...
        if (data == null || data.length % org.opencv.core.CvType.channels(t) != 0)
            throw new UnsupportedOperationException(
                    "Provided data element number (" +
                            ...
                            ") should be multiple of the Mat channels count (" +
                            org.opencv.core.CvType.channels(t) + ")");
        if (org.opencv.core.CvType.depth(t) == org.opencv.core.CvType.CV_8U || org.opencv.core.CvType.depth(t) == org.opencv.core.CvType.CV_8S) {
    ...
    public int put(int row, int col, byte[] data, int offset, int length) {
        int t = type();
        if (data == null || length % org.opencv.core.CvType.channels(t) != 0)
            throw new UnsupportedOperationException(
                    "Provided data element number (" +
                            (data == null ? 0 : data.length) +
                            ") should be multiple of the Mat channels count (" +
        ...
        if (data == null || data.length % org.opencv.core.CvType.channels(t) != 0)
            throw new UnsupportedOperationException(
                    "Provided data element number (" +
                            ...
                            ") should be multiple of the Mat channels count (" +
                            org.opencv.core.CvType.channels(t) + ")");
        if (org.opencv.core.CvType.depth(t) == org.opencv.core.CvType.CV_64F) {
    ...
    public int get(int[] idx, double[] data) {
        ...
        if (idx.length != dims())
            throw new IllegalArgumentException("Incorrect number of indices");
        if (org.opencv.core.CvType.depth(t) == CvType.CV_64F) {
